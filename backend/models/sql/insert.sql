...
Insert into rate values(NULL, 3, 5, "The catfood is great! Topsy loves it!", 4,"GREAT", NOW(), NOW());
Insert into rate values(NULL, 1, 4, "The cheese is nice. Unfortunately it seems I'm a bit allergic to it.", 3,"GREAT", NOW(), NOW());
Insert into rate values(NULL, 2, 5, "Why is the package full of feathers?",1,"GREAT", NOW(), NOW());
Insert into rate values(NULL, 4, 3, "*compliment with satisfication, in pigeon language*", 5,"GREAT", NOW(), NOW());
